    ...
    <section class="fullscreen-beige-background grid-x flex-center padding-top-eight">
        ...
        <form method="POST" action="{{ route('register') }}" class="login-form cell small-12 medium-6 large-5 grid-x grid-margin-x">
            ...
            <div class="cell small-12 medium-6">
                <label for="firstname" class="form-label label-seniors">{{ __('Vorname') }}</label>
            ...
            <div class="cell small-12 medium-6">
                <label for="lastname" class="form-label label-seniors">{{ __('Nachname') }}</label>
            ...
            <div class="cell small-12 medium-8">
                <label for="street" class="form-label label-seniors">{{ __('Straße') }}</label>
            ...
            <div class="cell small-12 medium-4">
                <label for="housenum" class="form-label label-seniors">{{ __('Hausnr.') }}</label>
            ...
            <div class="cell small-12 medium-4">
                <label for="postcode" class="form-label label-seniors">{{ __('PLZ') }}</label>
            ...
            <div class="cell small-12 medium-8">
                <label for="city" class="form-label label-seniors">{{ __('Stadt') }}</label>
            ...
            <div class="cell small-12">
                <label for="birthday" class="form-label label-seniors">{{ __('Geburtstag') }}</label>
            ...
            <div class="cell small-12">
                <label for="email" class="form-label label-seniors">{{ __('E-Mail-Addresse') }}</label>
            ...
            <div class="cell small-12">
                <label for="password" class="form-label label-seniors">{{ __('Passwort') }}</label>
            ...
            <div class="cell small-12">
                <label for="password-confirm" class="form-label label-seniors">{{ __('Passwort wiederholen') }}</label>
