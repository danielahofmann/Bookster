...
@section('main')
    <section class="grid-x flex-center">
        <div class="cell small-11">
            <h1>Impressum</h1>
            <p>Bei dieser Website handelt es sich um ein studentisches Projekt, welches in keinster Weise kommerziell verwendet wird. Die Veröffentlichung dient lediglich der Benotung.</p>
