    ...
    @if(!empty($products))
        <section class="grid-x grid-margin-x background-beige padding-bottom-large">
            ...
            <div class="cell small-12 medium-12 large-6 grid-x flex-center background-white padding-section margin-top-small display-mobile-none" style="height: 20vh">
                ...
                <a href="{{ route('teens-checkout') }}" class="checkout-button">ZUR KASSE</a>
            </div>

            <a href="{{ route('teens-checkout') }}" class="cell small-12 no-margin-mobile checkout-button display-mobile-only">ZUR KASSE</a>
        </section>
    @else
