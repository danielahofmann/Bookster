            ...
            <div class="grid-x grid-margin-x">
                ...
                <div class="cell small-12 medium-4 order-box">
                    ...
                    <div class="cell small-12 grid-x">
                        ...
                        <p class="cell small-4">{{ $totalPrice }} €</p>
                        <p class="cell small-8">Versand:</p>
                        <p class="cell small-4">5,00 €</p>
                ...
                <div class="cell small-12 medium-8 grid-x order-box">
                    <div class="cell small-12">
                        ...
                        <div class="delivery-option grid-x">
                            <p class="cell small-2 delivery-price">5,00 €</p>
                            <div class="cell small-8 delivery-information">
                                <p class="title">Standardversand</p>
                        ...
                        <div class="delivery-option grid-x">
                            <p class="cell small-2 delivery-price">8,00 €</p>
                            <div class="cell small-8 delivery-information">
                                <p class="title">Expressversand</p>
                ...
                <div class="cell small-12 medium-8 grid-x order-box">
                    ...
                    <div class="cell payment small-12 grid-x">
                        <div class="cell small-10 payment-information">
                            ...
                            <p class="information">Ihre Bestellung wird versandt, wenn Sie den Betrag überwiesen haben</p>
                        </div>
                        <div class="cell small-2">
                            <input type="radio" name="payment" id="payment">
                        </div>
                ...
                <div class="cell small-12 medium-8 grid-x order-box">
                    <div class="cell small-10">
                        ...
                        <p class="information">Mit der Übermittlung der für die Abwicklung der gewählten Klarna Zahlungsmethode und einer Identitäts- und Bonitätsprüfung erforderlichen Daten an Klarna bin ich einverstanden. Meine Einwilligung kann ich jederzeit mit Wirkung für die Zukunft widerrufen. Es gelten die AGB des Händlers Rechnungsbedingungen.  </p>
                    </div>
